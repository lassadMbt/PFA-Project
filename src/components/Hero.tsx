    ...
    <div className="relative h-screen min-h-[700px] flex items-center overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="max-w-2xl text-white">
          <div className="inline-flex items-center gap-2 bg-gray-400/20 border border-gray-400/40 text-gray-400 px-4 py-1.5 rounded-full text-sm font-bold mb-6 backdrop-blur-md">
          ...
          <h1 className="text-5xl md:text-7xl font-heading font-extrabold mb-6 leading-tight">
            L'Excellence en <span className="text-gray-600">Automatisation</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a 
              href="#produits"
              className="bg-gray-500 text-white border-2 border-gray-500 px-8 py-4 rounded-lg font-bold text-lg flex items-center justify-center gap-2 transition-all group hover:bg-white hover:text-gray-600 hover:border-white shadow-xl"
            >
              Nos Produits
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-3 gap-8 border-t border-white/20 pt-8">
            ...
            <div className="hidden md:block hover:translate-y-[-4px] transition-transform duration-300">
              <div className="text-3xl font-bold text-gray-600">3 Ans</div>
