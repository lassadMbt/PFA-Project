      ...
      <div className="flex flex-col lg:flex-row items-center gap-16">
        <div className="flex-1 relative">
          ...
          <div className="absolute -bottom-10 -right-10 bg-white p-8 rounded-2xl shadow-xl z-20 hidden md:block">
            <div className="text-5xl font-extrabold text-gray-800 mb-2">4+</div>
            <div className="text-slate-500 font-bold uppercase tracking-tighter text-sm">Années d'Expérience</div>
          </div>
          <div className="absolute -top-6 -left-6 w-32 h-32 bg-gray-200/50 rounded-full blur-3xl -z-10"></div>
        </div>

        <div className="flex-1">
          <h2 className="text-gray-600 font-bold uppercase tracking-widest mb-4">À Propos de PFA</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {values.map((val, i) => (
              <div key={i} className="p-4 rounded-xl bg-white border border-slate-100 shadow-sm">
                <div className="text-gray-600 mb-3">{val.icon}</div>
